    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='order_products', to='productapp.product', verbose_name='product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deliveryType', models.CharField(blank=True, default=None, max_length=100, verbose_name='delivery type')),
                ...
                ('products', models.ManyToManyField(related_name='orders', to='orderapp.orderproduct', verbose_name='order_products')),
